...
void forward(const double* q, double* T) {
    double s1, c1, d1, a2, s2, c2, c3, a3, s3, c5, s5,c6, s6, d5, d4, d6,s234, q234, c234;

    s1 = sin(*q), c1 = cos(*q); q++;
    q234 = *q, s2 = sin(*q), c2 = cos(*q); q++;
    s3 = sin(*q), c3 = cos(*q); q234 += *q; q++;
    q234 += *q; q++;
    s5 = sin(*q), c5 = cos(*q); q++;
    s6 = sin(*q), c6 = cos(*q);
    s234 = sin(q234), c234 = cos(q234);
...
int inverse(const double* T, double* q_sols, double q6_des) {
    int num_sols,i,j = 0;
    double T01, T02, T12,T22, T00,T10, T11, T20, T21, T13, T23,T03,arcsin,arccos,arctan, numer,a2, a3, d1, d6,d4;
    double q1[2];
    T02 = -*T; T++; T00 =  *T; T++; T01 =  *T; T++; T03 = -*T; T++;
    T12 = -*T; T++; T10 =  *T; T++; T11 =  *T; T++; T13 = -*T; T++;
    T22 =  *T; T++; T20 = -*T; T++; T21 = -*T; T++; T23 =  *T;
