...
#define MASTERBOARD_UR5_MAX_ROBOT_CURRENT_IN_ONE_SENSOR       (float) 15.0      /* [A] (FP) Used for fast short circuit protection on small control box. Note that there is no filter on this reading. */
