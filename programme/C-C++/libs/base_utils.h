...
// Protokol ids
#define PVA_PACKET_ID 0x01
#define SERVO_PACKET_ID 0x02
#define PPACKET_ID 0x03
...
extern struct message_t msg_buffer[MSG_BUFFER_SIZE];
extern char msg_text_buffers[MSG_BUFFER_SIZE][100];
